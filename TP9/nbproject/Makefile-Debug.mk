...
${OBJECTDIR}/CamelCase.o: CamelCase.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CamelCase.o CamelCase.c

${OBJECTDIR}/EsPalindromo.o: EsPalindromo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EsPalindromo.o EsPalindromo.c

${OBJECTDIR}/EsPalindromoNoRecursivo.o: EsPalindromoNoRecursivo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EsPalindromoNoRecursivo.o EsPalindromoNoRecursivo.c

${OBJECTDIR}/Get_String.o: Get_String.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Get_String.o Get_String.c
...
${TESTDIR}/tests/EsPalindromoSimpleTest.o: tests/EsPalindromoSimpleTest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EsPalindromoSimpleTest.o tests/EsPalindromoSimpleTest.c


${TESTDIR}/tests/CamelCaseSimpleTest.o: tests/CamelCaseSimpleTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CamelCaseSimpleTest.o tests/CamelCaseSimpleTest.c
...
${OBJECTDIR}/CamelCase_nomain.o: ${OBJECTDIR}/CamelCase.o CamelCase.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CamelCase_nomain.o CamelCase.c;\
	else  \
...
${OBJECTDIR}/EsPalindromo_nomain.o: ${OBJECTDIR}/EsPalindromo.o EsPalindromo.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EsPalindromo_nomain.o EsPalindromo.c;\
	else  \
...
${OBJECTDIR}/EsPalindromoNoRecursivo_nomain.o: ${OBJECTDIR}/EsPalindromoNoRecursivo.o EsPalindromoNoRecursivo.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EsPalindromoNoRecursivo_nomain.o EsPalindromoNoRecursivo.c;\
	else  \
...
${OBJECTDIR}/Get_String_nomain.o: ${OBJECTDIR}/Get_String.o Get_String.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Get_String_nomain.o Get_String.c;\
	else  \
